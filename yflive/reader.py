...
class QuoteReader:
    ...
    by yahoo!finance. These methods are mostly translated from the client side
    source code of the yahoo!finance webpage.
    """
    ...
    def parse(message):
        ...
        while reader.pos < c:
            ...
            if (t >> 3) == 1:       # Read id
                ...
                new_quote["currency"] = str(reader.read_string())
